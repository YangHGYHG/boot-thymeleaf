...
@Controller //@Cmponent, @Service, @Repository
...
public class UserController {
	...
	*/
	...
	public String updateUser(@PathVariable(value = "id") Long id, @Valid User updateUser, Model model) {
		/*
		 * updateUser 객체는 입력 폼 내용 : id 값이 없음, 
		 */
		User user = userService.getUserById(id);//user는 DB로 부터 읽어온 객체
